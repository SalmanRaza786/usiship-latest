...
@section('content')
    @component('components.breadcrumb')
        ...
        @endslot
        @slot('title')
            Missing Detail - {{$data['orderInfo']->workOrder->order_reference}}
        @endslot
    @endcomponent
                    ...
                    <div class="card-header d-flex ">
                        ...
                        <div class="col-auto justify-content-sm-end">
                            ...
                            @if($data['orderInfo']->end_time==null)
                                <button type="button" class="btn btn-success btn-close-resolve me-2 d-none"
                                        data-bs-toggle="modal" data-bs-target="#confirmCloseModal"><i
                                        class="ri-eye-line align-bottom me-1"></i> Close Resolve
                                </button>
                            @endif


                            <button type="submit" class="btn btn-success btn-start-resolve d-none" updateType="1"><i
                                    class="ri-add-line align-bottom me-1"></i> Start Resolve
                            </button>
                            ...
                            <div class="row gy-4">
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="basiInput"
                                               value="{{$data['orderInfo']->workOrder->order_reference}}" disabled="">
                                    </div>
                                </div>
                                <!--end col-->
                                <div class="col-xxl-3 col-md-6">
                                ...
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="start_pick_time"
                                               value="{{$data['orderInfo']->start_time}}" disabled="">
                                    </div>
                                </div>
                                <div class="col-xxl-3 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" id="valueInput"
                                               value="{{$data['orderInfo']->workOrder->loadType->eqType->value}}"
                                               disabled="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="invoice-table table table-borderless table-nowrap mb-0">
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            <td class="text-start" style="width: 150px;">
                                                <div class="mb-2">
                                                    <input class="form-control bg-light border-0" style="width: 170px;"
                                                           type="file" name="resolveItemImages[{{$key}}][]"
                                                           placeholder="Damage" multiple accept="image/*">
                                                </div>
                                                @isset($row->media)
                                                    <div
                                            ...
                                            <td class="text-end">
                                                <select name="newLocId[]" id="" class="form-select js-example-basic-single new-loc-id" required>
                                                    <option value="">Choose One</option>
                                                    @isset($data['missedItems'])
                                                        @foreach($data['locations'] as $loc)
                                                            <option value="{{$loc->id}}"
                                            ...
                                            <td class="text-start" style="width: 150px;">
                                                <div class="mb-2">
                                                    <input class="form-control bg-light border-0" style="width: 170px;"
                                                           type="file" name="newLocationItemImages[{{$key}}][]"
                                                           placeholder="Damage" multiple accept="image/*">
                                                </div>
                                            ...
                                            <td class="text-end  cursor-pointer text-success btn-save-row" title="Save"
                                                data="{{$row->id}}"><i class="ri-save-2-fill fs-1"></i></td>
