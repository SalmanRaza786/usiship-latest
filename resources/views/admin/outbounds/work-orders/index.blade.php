            ...
            columnDefs: [

                {
                    ...
                    render: function(data, type, row, meta) {
                        var btnPerm = ' @canany('admin-permission-view')<a href="#" type="button" class="btn btn-primary btn-check-in" data-bs-toggle="modal" data-bs-target="#checkInModal">Assign Now</a>@endcanany';
                        var btnEdit = ' @canany('admin-role-edit')<a href="#" type="button" class="btn btn-primary btn-check-in"  data-bs-toggle="modal" data-bs-target="#checkInModal">Upload Bol Document</a>@endcanany';
                        var btnDelete = ' @canany('admin-role-delete')<a href="#" type="button" class="btn btn-primary btn-check-in"  data-bs-toggle="modal" data-bs-target="#checkInModal">Schedule Now</a>@endcanany';
